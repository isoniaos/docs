...
All notable public documentation changes are tracked here.

## Unreleased

### Added

- Added human-facing public sections for getting started, concepts, developers, operators, and reference.
- Added public guidance for governance lifecycle, accountability/evidence, authority/trust boundaries, local runtime, diagnostics, configuration, repository links, and documentation maintenance.
