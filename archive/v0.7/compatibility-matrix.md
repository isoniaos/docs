...
| Metadata/storage schema baseline | Informal | Defined | Includes object taxonomy, schema versioning, upload intents, CID registry, gateway policy, and privacy guidance. Storage service implementation is non-goal. |
