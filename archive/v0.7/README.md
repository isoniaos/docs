# IsoniaOS v0.7 Archived Documentation Pack

IsoniaOS v0.7 is archived. It preserves the protocol-hardening foundation that v0.8 builds on: typed admin batch activation, bootstrap finalization, admin handoff, lifecycle visibility, Proposal Action Builder design, and storage/metadata schema direction.

The active planning and architecture baseline is now [`../../v0.8/`](../../v0.8/).

Historically, v0.7 moved the project from a demo-ready product foundation toward protocol hardening and real governance execution foundations.
